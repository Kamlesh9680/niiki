...
const PdfViewerComponent7 = () => {
    const [selectedPdf, setSelectedPdf] = useState(null);

    // Example PDF data
    const pdfFiles = [
        { id: 1, name: "Cash Loan", url: "doc/cash-loan.pdf", icon: '/phonepe-icon.webp' },
    ];
...
export { PdfViewerComponent, PdfViewerComponent2, PdfViewerComponent3, PdfViewerComponent4, PdfViewerComponent5, PdfViewerComponent6, PdfViewerComponent7 };
